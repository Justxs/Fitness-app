...
namespace FitnessApp.Database.Models
{
    public partial class FitnessAppDbContext : IdentityDbContext<User,Role,int>
    {
        ...
        {
            modelBuilder.Entity<FoodRecord>().HasData(new FoodRecord { Id = 1, Name = "Steak", Proteins = 15, Carbohydrates = 65.2f, Fats = 4.9f, Calories = 364.9f, ImageUrl = "", UserId = 2},
                                                       new FoodRecord { Id = 2, Name = "Whole grain bread", Proteins = 6.98f, Carbohydrates = 37.2f, Fats = 1.16f, Calories = 209.3f, ImageUrl = "", UserId = 2 },
                                                       new FoodRecord { Id = 3, Name = "Pineapple Pizza", Proteins = 9.4f, Carbohydrates = 30.2f, Fats = 8.1f, Calories = 230.1f, ImageUrl = "", UserId = 2 },
                                                       new FoodRecord { Id = 4, Name = "Milk", Proteins = 3.3f, Carbohydrates = 4.9f, Fats = 2f, Calories = 50f, ImageUrl = "", UserId = 2 });
